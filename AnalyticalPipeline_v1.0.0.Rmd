...
groupEBE(data=dic.data,stage=10,stageLabel="wake",metricsType="avg",CI.type="boot",advancedMetrics=FALSE)
...
groupEBE(data=dic.data,stage=10,stageLabel="wake",metricsType="sum",advancedMetrics=FALSE)
